...
class DelegatingDataBasedPermissionEvaluatorImplTest {

    private IOnkostarApi onkostarApi;

    private PersonPoolBasedPermissionEvaluatorImpl personPoolBasedPermissionEvaluator;

    private FormBasedPermissionEvaluatorImpl formBasedPermissionEvaluator;

    private DelegatingDataBasedPermissionEvaluatorImpl delegatingDataBasedPermissionEvaluator;

    @BeforeEach
    void setup(
            @Mock IOnkostarApi onkostarApi,
            @Mock PersonPoolBasedPermissionEvaluatorImpl personPoolBasedPermissionEvaluator,
            @Mock FormBasedPermissionEvaluatorImpl formBasedPermissionEvaluator
            ) {
        ...
        this.delegatingDataBasedPermissionEvaluator = new DelegatingDataBasedPermissionEvaluatorImpl(
