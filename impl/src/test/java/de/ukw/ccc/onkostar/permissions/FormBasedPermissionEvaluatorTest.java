...
class FormBasedPermissionEvaluatorTest {
    ...
    private FormBasedPermissionEvaluatorImpl permissionEvaluator;
    ...
    void setup(
        ...
        this.permissionEvaluator = new FormBasedPermissionEvaluatorImpl(
    ...
    void testShouldVoteForPermissionToIdOfTypeProcedure() {
        var actual = permissionEvaluator.hasPermission(this.dummyAuthentication, 123, FormBasedPermissionEvaluatorImpl.PATIENT, PermissionType.READ);
        assertThat(actual).isTrue();
    }
