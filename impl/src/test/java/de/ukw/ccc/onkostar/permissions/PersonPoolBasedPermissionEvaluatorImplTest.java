...
class PersonPoolBasedPermissionEvaluatorImplTest {

    private IOnkostarApi onkostarApi;

    private Authentication dummyAuthentication;

    private PersonPoolBasedPermissionEvaluatorImpl permissionEvaluator;
    ...
    void setup(
        ...
        this.permissionEvaluator = new PersonPoolBasedPermissionEvaluatorImpl(
    ...
    void testShouldGrantPermissionByPatientIdAndType() {
        ...
        var actual = permissionEvaluator.hasPermission(this.dummyAuthentication, 123, PersonPoolBasedPermissionEvaluatorImpl.PATIENT, PermissionType.READ);
    ...
    void testShouldGrantPermissionByProcedureIdAndType() {
        ...
        var actual = permissionEvaluator.hasPermission(this.dummyAuthentication, 456, PersonPoolBasedPermissionEvaluatorImpl.PROCEDURE, PermissionType.READ);
    ...
    void testShouldDenyPermissionByProcedureIdAndType() {
        ...
        var actual = permissionEvaluator.hasPermission(this.dummyAuthentication, 123, PersonPoolBasedPermissionEvaluatorImpl.PROCEDURE, PermissionType.READ);
